...
type MasterReport struct {
	...
	StartDate                  string `json:"startDate" gorm:"column:start_date"` // optional, but if provided must be a valid date
}
...
type FullReport struct {
	...
	StartDate                  string    `gorm:"column:start_date;default:null"`
