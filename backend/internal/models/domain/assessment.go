...
type Assessment struct {
	...
	TutorialContent      *string  `json:"tutorialContent" gorm:"column:tutorial_content;type:longtext"`
	TutorialTimerMinutes *float64 `json:"tutorialTimerMinutes" gorm:"column:tutorial_timer_minutes;default:1"`
