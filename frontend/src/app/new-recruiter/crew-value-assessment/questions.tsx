...
export default function Questions({
  ...
  const { timeLeft } = useCountdown(assessmentData.assessmentStartTime, timerMinutes, undefined);
  ...
  }, [assessment?.questions, answers, assessmentData.token, mutate, timeLeft, role]);
