            ...
            <div className="bg-white rounded-lg shadow-sm border p-8 mb-3">
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed">
                <p>
                  ...
                  <strong>CES (Crew Evaluation System)</strong> yang bertujuan
                  untuk memetakan kompetensi awak kapal secara objektif. Hasil
                  dari asesmen ini akan digunakan sebagai dasar dalam mendukung
                  program pengembangan karier dan peningkatan kualitas sumber
                  daya manusia di perusahaan.
                </p>

                <p>
                  Dalam asesmen ini, bacalah setiap instruksi dan soal dengan
                  teliti, kemudian pilihlah jawaban yang menurut Anda paling
                  sesuai. Tidak ada jawaban benar atau salah, sehingga jawablah
                  seluruh pertanyaan dengan jujur agar hasilnya dapat
                  mencerminkan gambaran diri Anda yang sebenarnya.
                </p>

                <p>
                  Seluruh data akan dijaga kerahasiaannya dan hanya digunakan
                  untuk kepentingan internal perusahaan. Jika terdapat
                  pertanyaan terkait asesmen ini, Anda dapat menghubungi:
                </p>
