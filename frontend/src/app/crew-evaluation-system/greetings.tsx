  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border p-8 mb-3">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="text-center">
              ...
              {/* <p className="text-lg text-gray-600 font-medium">Competency Evaluation System</p> */}
            </div>
        ...
        {/* Welcome Content */}
        <div className="bg-white rounded-lg shadow-sm border p-8 mb-3">
          <h2 className="text-2xl font-bold text-gray-800 mb-6">Salam Hangat!</h2>
          
          <div className="space-y-4 text-gray-700 leading-relaxed">
            <p>
              Asesmen ini merupakan bagian dari <strong>CES (Competency Evaluation System)</strong> yang bertujuan untuk 
              memetakan kompetensi awak kapal secara objektif. Hasil dari asesmen ini akan digunakan sebagai dasar 
              dalam mendukung program pengembangan karier dan peningkatan kualitas sumber daya manusia di perusahaan.
            </p>
            
            <p>
              Dalam asesmen ini, bacalah setiap instruksi dan soal dengan teliti, kemudian pilihlah jawaban yang 
              menurut Anda paling sesuai. Tidak ada jawaban benar atau salah, sehingga jawablah seluruh pertanyaan 
              dengan jujur agar hasilnya dapat mencerminkan gambaran diri Anda yang sebenarnya.
            </p>
            
            <p>
              Seluruh data akan dijaga kerahasiaannya dan hanya digunakan untuk kepentingan internal perusahaan. 
              Jika terdapat pertanyaan terkait asesmen ini, Anda dapat menghubungi:
            </p>
            ...
            <p>
              Atas waktu dan kesediaan Anda dalam mengikuti asesmen ini, kami ucapkan terima kasih.
            </p>
